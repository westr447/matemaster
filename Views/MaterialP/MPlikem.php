...
$params = $user->bookmarkall();

?>

<ul id="id01" class="sortlist">
  <?php foreach($params['favoritematerialtable']  as $mate): ?>
   <div class="matelist">
     <li class="matenara">
       <div class="nakakomi">
         ...
         <div class="titlebtnset">
           ...
           <div class="titlebtn">
             <?php echo'<a href="./MPlikedel.php?ID='.$mate['ID'].'"onClick="return up()">
